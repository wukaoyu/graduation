...
class AdminTestPaper extends React.Component {
  constructor (props) {
    super(props)
                      ...
                      <Card style={{ width: 280, marginTop: 16, marginRight: 16 }} hoverable title={item.name}>
                        ...
                        <div>
                          <div className='paper-list-handle'>
                            <Button size='small' className='paper-list-handle-btn' onClick={() => this.toEditorTestPaperQuestion(item.id)}>查看题目</Button>
  ...
  toEditorTestPaperQuestion = id => {
    this.props.history.push('/admin/course/editorTestPaper?id=' + id + '&courseId=' + this.state.params.id)
  }
}

export default AdminTestPaper